...
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.restaurant.domain.auth.UserRole'
grails.plugin.springsecurity.authority.className = 'com.restaurant.domain.auth.Role'
