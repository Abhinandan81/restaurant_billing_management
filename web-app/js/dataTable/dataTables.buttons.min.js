...
(function (e) {
    ...
    var i = e.fn.dataTable, t = 0, u = 0, j = i.ext.buttons, l = function (a, b) {
        !0 === b && (b = {});
    ...
    e.extend(l.prototype, {
        action: function (a, b) {
            ...
            var c, d, f, g;
            f = this.s.buttons;
            var k = this.s.subButtons, h = function (c, d) {
    ...
    l.instanceSelector = function (a, b) {
        ...
        var c = [], d = e.map(b, function (a) {
            ...
            if (e.isArray(a))for (var k = 0, h = a.length; k < h; k++)f(a[k]); else"string" === typeof a ? -1 !== a.indexOf(",") ? f(a.split(",")) : (a = e.inArray(e.trim(a), d), -1 !== a && c.push(b[a].inst)) : "number" === typeof a && c.push(b[a].inst)
        };
        f(a);
        return c
    };
    l.buttonSelector = function (a, b) {
        for (var c =
            ...
            if (e.isArray(a) || a instanceof e) {
                ...
                j = a.replace(":name", "");
                f = 0;
                for (g = i.length; f < g; f++)i[f].name === j && c.push({inst: b, idx: b.toIndex(i[f].node)})
    ...
    i.Api.register("buttons.exportData()", function (a) {
        if (this.context.length) {
            ...
            return {header: a, footer: f, body: l}
        }
    });
    var s = e("<textarea/>")[0];
